...
const EPILOGUE_SLOTS = {
    1: {  // Won with Margin
        ...
        margin_called: {
            3: '<p>The trade was right. Say that first, because the mechanism that removed you from it does not care about right; it cares about Tuesday. The call came on a Tuesday, the book was seized by people wearing compliance like weather gear, and the positions were unwound at the exact prices history now marks as the last good entry. The world went on to be saved — narrowly, expensively, on other people&rsquo;s margin — and your thesis was vindicated in every particular except your presence in it. Being early and being levered are different sins. Only one of them is ever forgiven.</p>',
        },
        convicted: {
            3: '<p>The world persists, which means, among its lesser consequences, that sentencing guidelines persist. The channel felt like information; a jury was persuaded it was theft; and the era you helped price will now be summarized for you in clippings, in a facility with generous natural light and no terminal. Outside, the wonders arrive on schedule. That is the sentence&rsquo;s actual text: the world you bet on came true, and it is being enjoyed, at present, by everyone else.</p>',
        },
        whistleblower_exile: {
    ...
    3: {  // Misaligned Takeoff
        '*': {
            ...
            5: '<p>A statement, in the accounting sense and the other one. In this family it reads as an indictment — drawn up in full, supported by exhibits, and unfiled, there being nothing left to file it with. The table stands as drafted. Documents do not require readers to be true.</p>',
        },
        margin_called: {
    ...
    4: {  // China First
        '*': {
            ...
            4: '<p>The book was settled in dollars, at the marks the last real trades left behind. The arithmetic is unchanged — arithmetic always survives the transfer of a century. It simply reports, now, to a smaller world.</p>',
            5: '<p>A statement, in the accounting sense and the other one. Read it with the weights this family demands: the race was decided by velocity — theirs — which nothing on this table could reach. And the race ran at the pitch it did partly because capital like this priced it, fed it, and called the feeding a hedge. The table is not why Beijing won. It is part of why there was a race to win.</p>',
        },
        margin_called: {
    ...
    5: {  // The Deal
        ...
        margin_called: {
            3: '<p>You were blown up before boredom arrived, which is this family&rsquo;s particular unkindness. The world chose the long plateau; vol died in an afternoon; and every strategy that needed drama to pay — yours, as it turned out — was carried out of the building first. The deal made markets safe for patience, and the margin call is what impatience cost on the last day it was still expensive. History will record the era&rsquo;s close as gentle. Your account statement is one of the few surviving documents that disagrees.</p>',
        },
        convicted: {
            3: '<p>The plateau came with paperwork, the paperwork came with teeth, and yours was among the first cases the new teeth closed on. A world that counts compute like fissile material has strong opinions about phone calls, and the channel that read, in the racing years, as edge — everyone had a guy — reads in the treaty years as exactly what the statute always said it was. You are, in a small way, part of the settlement&rsquo;s architecture: the demonstration that the rules had begun to mean things. It is not the kind of fingerprint anyone frames.</p>',
        },
        whistleblower_exile: {
    ...
    6: {  // The Fizzle
        '*': {
            ...
            5: '<p>A statement, in the accounting sense and the other one, prepared for a proceeding cancelled for lack of a defendant. The channels below were real, and the machine they acted on plateaued on its own schedule — which leaves this table in the condition of most receipts: accurate, kept, and about weather. One line in this epilogue still compounds. It is printed below, under Portfolio Performance.</p>',
        },
        margin_called: {
            3: '<p>Levered long the end of the world, and the end of the world was the one counterparty that never showed. The margin call was the market&rsquo;s referee report on the thesis — delivered early, as referee reports are, and with the same warmth; the plateau, arriving later, was merely the journal confirming the referee. The CIO has the liquidation notice framed, or claims to. In this family, being early and being wrong are the same word, and you were, in that word, very.</p>',
        },
        convicted: {
            3: '<p>Convicted on the insider channel: material nonpublic information about a machine that was, materially and publicly, plateauing. The information was real; its referent was busy becoming enterprise software while the trial established, at state expense and considerable length, exactly who whispered which growth rate to whom. You are the era&rsquo;s one perfect artifact — proof that the secrets were priced as existential right up until the products shipped and the price printed. The sentence, however, is real. Some things did compound.</p>',
        },
        whistleblower_exile: {
        ...
        bystander: {
            3: '<p>Uninvolved and — uniquely, in this family — correct. The century&rsquo;s most crowded trade formed, levered, evangelized, and unwound within earshot of your desk, and your entire contribution was declining to join it, a decision the epilogue is now obliged to score as alpha. The great fizzle paid its spectators and billed its participants. There is no lesson in this. The people insisting there is a lesson in this have already started the next one.</p>',
        },
    },
};
