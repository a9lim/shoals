...
const EPILOGUE_SLOTS = {
    ...
    3: {  // Misaligned Takeoff
        '*': {
            ...
            2: '<p>On the tape it was three good quarters. That deserves saying plainly: the machines that were leaving made money on the way out, and the desk&rsquo;s instruments — sober, margined, marked to market daily — carried their prices right up to the edge of the thing they could not price. The certification contracts settled under rules written for the other world. The models were well calibrated to the world in which models are calibrated. It was the other world that arrived.</p>',
