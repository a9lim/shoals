...
export const MARKET_EVENTS = [
    ...
    // =====================================================================
    {
        ...
        category: 'sector',
        likelihood: 0.7,
        headline: 'AI regulation bill passes Congress with bipartisan support; mandates safety audits, licensing for frontier models. Analysts on MarketWire: "Compliance costs will be material — $200M/year minimum." Safety advocates call it "long overdue."',
        magnitude: 'moderate',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 0.6,
        headline: 'DOJ files antitrust suit against three major cloud providers alleging market allocation; enterprise AI contracts could be voided. The Meridian Brief: "If these contracts unwind, the biggest compute platforms are the biggest beneficiaries — or the biggest casualties."',
        magnitude: 'moderate',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.0,
        headline: 'TSMC warns of 16-week lead times on advanced nodes; AI chip allocations cut 30%. Compute buyers scramble for alternative sourcing. The Meridian Brief flags unusual options activity ahead of the announcement.',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.8,
        headline: 'Gartner raises enterprise cloud spending forecast 20%; AI workloads driving "unprecedented demand." The Meridian Brief: "Compute infrastructure is the picks-and-shovels play, and everyone knows it."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 0.5,
        headline: 'Major cyberattack takes down power grid in three states; CISA attributes to Russian state-sponsored actors. The Sentinel runs a primetime special: "Digital Pearl Harbor."',
        magnitude: 'moderate',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 0.8,
        headline: 'Zhaowei\'s Qilin-4 model tops the leading U.S. frontier models on three major AI benchmarks; Liang Wei: "The gap is closed." Sharma: "Benchmark wars are marketing. Revenue is reality."',
        magnitude: 'moderate',
        params: { mu: -0.01, theta: 0.005 },
    },
    {
        ...
        category: 'sector',
        likelihood: 1.5,
        headline: 'Zhaowei CEO Liang Wei keynotes Beijing AI Summit; announces state-backed $50B compute buildout. Analysts call it "a Sputnik moment for American AI." The Meridian Brief: "American AI just got a competitor with a sovereign balance sheet."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.0,
        headline: 'G7 nations agree on international AI safety framework; voluntary compliance for now, but binding treaty language being drafted. Industry splits publicly over whether to endorse it. Sharma: "The framework has no teeth yet. Yet."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 0.8,
        headline: 'Major lab announces 1,000-qubit error-corrected quantum processor; "practical quantum advantage within 3 years." The Meridian Brief: "If this is real, every encryption standard the sector relies on has an expiration date." Quantum stocks surge.',
    ...
    // -- Dividend / corporate payout events --------------------------------
    {
        ...
        category: 'sector',
        likelihood: 0.8,
        headline: 'S&P 500 dividend payments hit record high; 40 companies raised payouts this quarter. The Meridian Brief: "Cash is king and companies are returning it. Watch for more names to follow suit."',
    ...
    // -- Positive tech / AI tailwinds -----------------------------------------
    {
        ...
        category: 'sector',
        likelihood: 0.8,
        headline: 'Congress passes bipartisan $200B "American AI Leadership Act"; mandates federal agencies adopt AI platforms within 3 years. Frontier labs call it a landmark. The Meridian Brief: "The government just became the biggest AI customer in the country."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.5,
        headline: 'McKinsey raises AI enterprise adoption forecast for third time this year; now projects 80% of Fortune 500 will deploy by year-end. Executives quote the report on earnings calls: "Faster than mobile, faster than cloud."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.0,
        headline: 'TSMC breaks ground on $40B U.S. fab; AI chip supply constraints easing as industry invests record $150B in new capacity. The Meridian Brief: "Good news for compute margins. Lead times finally improving."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.2,
        headline: 'AI venture funding hits $80B in a single quarter, shattering all records. Sharma on MarketWire: "Every pitch deck has AI in it. Most of them are running on somebody else\'s compute."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.5,
        headline: 'Big Tech collectively guides AI capex up 60% next year; hyperscalers in an "arms race" for compute. The Meridian Brief: "Infrastructure is the new oil."',
    ...
    },
    {
        ...
        headline: 'Leveraged vol ETP liquidation cascade: inverse-VXHCN fund NAV collapses 90%, forced rebalancing hammers futures. Sharma on MarketWire: "The vol complex just detonated. This is 2018 all over again."',
        magnitude: 'major',
    ...
    },
    {
        ...
        category: 'market',
        likelihood: 2.0,
        headline: 'VXHCN touches single digits as realized vol plumbs post-crisis lows. Sharma: "Single-digit VXHCN. The last two times this happened, it ended badly." The Meridian Brief: "Vol sellers are printing. Until they\'re not."',
    ...
    },
    {
        ...
        category: 'market',
        likelihood: 1.2,
        headline: 'Japanese and European investors rotate into U.S. tech equities as dollar stabilizes; EPFR data shows largest ex-U.S. allocation to American stocks in a decade. Sharma: "Foreign money is chasing the AI leaders."',
