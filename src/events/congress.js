...
export const CONGRESS_EVENTS = [
...

    {
        ...
        choices: [
            {
                label: 'Brace for turbulence',
                desc: 'Tell the desk you expect a contested result. Tighten risk limits and prepare for a volatile session.',
                deltas: { xi: 0.01, theta: 0.005 },
                playerFlag: 'bought_election_protection',
                resultToast: 'Risk limits tightened. The desk is ready for whatever the count delivers.',
            },
            {
                label: 'Bet on calm',
                desc: 'The vol premium is overdone. Signal confidence that markets will shrug off the result.',
                deltas: { xi: -0.005, theta: 0.003 },
                playerFlag: 'sold_election_vol',
                resultToast: 'You called the market overreaction. If the election is orderly, you look prescient.',
            },
            {
                label: 'Step aside',
                desc: 'This isn\'t your fight. Watch from the sidelines and reassess after the dust settles.',
                deltas: { theta: -0.005 },
                playerFlag: 'flattened_for_election',
                resultToast: 'You sit this one out. The results roll in while you nurse a glass of bourbon.',
            },
        ],
    },
